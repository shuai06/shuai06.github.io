...
![读取成功](http://image.geoer.cn/img/image-20220118110911969.png)
...
![字符串参数的exec的实现](http://image.geoer.cn/img/image-20220118104123543.png)

`StringTokenizer`对传入的字符串命令参数进行处理，然后再调用` exec(String[] cmdarray, String[] envp, File dir)`

![image-20220118104339231](http://image.geoer.cn/img/image-20220118104339231.png)

关键点就在于`StringTokenizer`如何进行处理的，跟进去发现：

![StringTokenizer](http://image.geoer.cn/img/image-20220118104549229.png)
