...
![](https://geoer666-1257264766.cos.ap-beijing.myqcloud.com/msf_1.png)


#### 技术架构
**1.辅助模块（auxiliary）**
包含了扫描、嗅探、指纹识别、网络欺骗等相关功能模块
![](https://geoer666-1257264766.cos.ap-beijing.myqcloud.com/msf_2.png)

**2.渗透攻击模块(exploits)**
利用程序，针对漏洞、权限进行利用，是主要使用的模块
![](https://geoer666-1257264766.cos.ap-beijing.myqcloud.com/msf_3.png)

**3.攻击载荷模块(payload)**
用于在目标系统中运行任意命令或者执行特定代码，主要用于shell获取
![](https://geoer666-1257264766.cos.ap-beijing.myqcloud.com/msf_5.png)

**4.空指令模块(nops)**
![](https://geoer666-1257264766.cos.ap-beijing.myqcloud.com/msf_5.png)

**5.编码器模块(encoders)**
![](https://geoer666-1257264766.cos.ap-beijing.myqcloud.com/msf_6.png)

**6.后渗透攻击模块(post)**
![](https://geoer666-1257264766.cos.ap-beijing.myqcloud.com/msf_7.png)
...
#### 为什么要使用Metasploit
![](https://geoer666-1257264766.cos.ap-beijing.myqcloud.com/msf_8.png)
开发版是没有生成报告的功能的（商业版才有），但是开发版的脚本更多，每个版本各有利弊

1. 情报搜集阶段
![](https://geoer666-1257264766.cos.ap-beijing.myqcloud.com/msf_9.png)
有数据库

2. 威胁建模阶段
![](https://geoer666-1257264766.cos.ap-beijing.myqcloud.com/msf_10.png)

3. 漏洞分析阶段
![](https://geoer666-1257264766.cos.ap-beijing.myqcloud.com/msf_11.png)

4. 后渗透攻击模块
![](https://geoer666-1257264766.cos.ap-beijing.myqcloud.com/msf_13.png)
...
```
![](https://geoer666-1257264766.cos.ap-beijing.myqcloud.com/msf_14.png)
...
set xxx
```
![](https://geoer666-1257264766.cos.ap-beijing.myqcloud.com/msf_15.png)

**4.探测服务详细信息**
![](https://geoer666-1257264766.cos.ap-beijing.myqcloud.com/msf_16.png)
...
![](https://geoer666-1257264766.cos.ap-beijing.myqcloud.com/msf_17.png)
