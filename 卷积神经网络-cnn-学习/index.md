...
![](http://image.geoer.cn/20220729202558.png)
...
ReLU -（Pooling）`连接。
![](http://image.geoer.cn/20220729202801.png)
...
![](http://image.geoer.cn/20220729223317.png)
...
边缘检测包括垂直检测和水平检测：
![](http://image.geoer.cn/20220729204217.png)
以垂直边缘检测为例：
...
![](http://image.geoer.cn/20220729205212.png)


然后依次移动计算第二个元素，进行相同的运算，求出对应第2个第三个位置的值：
![](http://image.geoer.cn/20220729205353.png)


继续移动到下一行进行计算：
![](http://image.geoer.cn/20220729205418.png)


直到计算出所有结果：
![](http://image.geoer.cn/20220729205510.png)

上述垂直检测的步骤在课后习题中，使用的是`conv_forward`函数来实现，在tensflow使用的是`tf.conv2d`,......


当然检测水平边缘也是类似的：
![](http://image.geoer.cn/20220729210348.png)


xx3x3的filter中填充的数字的值到底为多少仍有争议xx：
![](http://image.geoer.cn/20220729210709.png)
有不同的filter
...
维度公式：
![](http://image.geoer.cn/20220729210858.png)
...
![](http://image.geoer.cn/20220729215915.png)
...
![](http://image.geoer.cn/20220729211049.png)
...
- same卷积-->有足够的填充
![](http://image.geoer.cn/20220729211243.png)
...
![](http://image.geoer.cn/20220729211454.png)
![](http://image.geoer.cn/20220729211623.png)
...
![](http://image.geoer.cn/20220729220354.png)

2.
![](http://image.geoer.cn/20220729220413.png)

当除不尽的时候，一般使用`floor`向下取整


补充：交叉相关(cross correlation)
![](http://image.geoer.cn/20220729212215.png)
...
![](http://image.geoer.cn/20220729214817.png)

然后移动到下一个位置，继续做27个(3x3x3)次相乘并求和
![](http://image.geoer.cn/20220729214908.png)


> Note：根据想在哪个颜色上检测边缘，来决定在第几层通道设置上值，而另外的通道设置为0

![](http://image.geoer.cn/20220729215035.png)
...
### 一个&多个卷积核
#### 一个卷积核
![](http://image.geoer.cn/20220729222402.png)



#### 两个(多个)卷积核
![](http://image.geoer.cn/20220729222449.png)



### 构建卷积网络的一层
![](http://image.geoer.cn/20220729221305.png)
![](http://image.geoer.cn/20220729221342.png)

![](http://image.geoer.cn/20220729221410.png)


课后习题用到的符号的总结：
![](http://image.geoer.cn/20220729221234.png)
...
![](http://image.geoer.cn/20220729220837.png)
![](http://image.geoer.cn/20220729221002.png)
![](http://image.geoer.cn/20220729221035.png)
...
### Max Pooling(最大池化)
> 常用，效果也比较好
![](http://image.geoer.cn/20220729221642.png)
...
![](http://image.geoer.cn/20220729221518.png)


Pooling的总结：
![20220729221537](http://image.geoer.cn/20220729221537.png)
...
## 为什么使用卷积？
![](http://image.geoer.cn/20220729222113.png)


**使用卷积网络的两个原因：**
![](http://image.geoer.cn/20220729222202.png)
...
![](http://image.geoer.cn/20220729231524.png)
...
![](http://image.geoer.cn/20220730100445.png)
![](http://image.geoer.cn/20220730101056.png)
...
![](http://image.geoer.cn/20220730100655.png)
...
![](http://image.geoer.cn/20220730103517.png)
...
![](http://image.geoer.cn/20220730102535.png)
![](http://image.geoer.cn/20220730102551.png)
![](http://image.geoer.cn/20220730102941.png)

**普通网络：**
![](http://image.geoer.cn/20220730102657.png)


**残差网络：**
所训练网络越深，训练误差越小。下图的残差网络由五个残差块组成，该残差网络只跳跃了一层，还可跳跃多层
![](http://image.geoer.cn/20220730102737.png)


举例：
![](http://image.geoer.cn/20220730103714.png)
...
ResNet的各种网络结构图:
![](http://image.geoer.cn/20220730131358.png)
...
![](http://image.geoer.cn/20220730115722.png)
一般来说，如果过滤器不止一个，而是多个，就好像有多个输入单元，其输入内容为一个切片上所有数字，输出结果是6×6过滤器数量。
![](http://image.geoer.cn/20220730115843.png)
...
![](http://image.geoer.cn/20220730115916.png)
...
![](http://image.geoer.cn/20220730120142.png)
...
![](http://image.geoer.cn/20220730130549.png)
...
![](http://image.geoer.cn/20220730110652.png)


###### 2. 减少计算成本
![](http://image.geoer.cn/20220730110847.png)
...
![](http://image.geoer.cn/20220730103231.png)
要是有一个更大的训练集，如图所示，我们冻结更少的层，然后训练后面的层；
![](http://image.geoer.cn/20220730103248.png)
或者如图3所示，换成自己的网络结构。
![](http://image.geoer.cn/20220730103302.png)
...
![](http://image.geoer.cn/20220730133720.png)
...
![](http://image.geoer.cn/20220730133504.png)

![](http://image.geoer.cn/20220730133518.png)
