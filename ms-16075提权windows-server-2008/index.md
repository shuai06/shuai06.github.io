...
2.先看一下当前权限(确保我没有作弊)
![](https://geoer666-1257264766.cos.ap-beijing.myqcloud.com/ms16075_download.png)
...
```
![](https://geoer666-1257264766.cos.ap-beijing.myqcloud.com/ms16075_poc.png)

可以看到可能存在ms16-075漏洞
![](https://geoer666-1257264766.cos.ap-beijing.myqcloud.com/ms16075_in.png)
...
getuid                # 查看当前权限
```
![](https://geoer666-1257264766.cos.ap-beijing.myqcloud.com/ms16075_ok.png)
